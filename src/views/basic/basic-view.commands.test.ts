...
describe('BasicView ΓÇô keyboard handlers', () => {
    let view: BasicView;
    let model: CubeController;
...
describe('BasicView ΓÇô linked rotation listener', () => {
    let view: BasicView;
    let model: CubeController;
    ...
    it('ignores BASIC_VIEW_ROTATION_LINKED from a different family', () => {
        ...
        // Post-cutover there is no separate basic-2 family — basic-2-front is
        // same-family now. Use a genuinely different family (flat) instead.
        Application.eventBus.emit(EventName.BASIC_VIEW_ROTATION_LINKED, {
            rotation: 'left',
...
describe('BasicView ΓÇô linked reset listener', () => {
    let view: BasicView;
    let model: CubeController;
...
describe('BasicView ΓÇô setState with faceDirectMode and linked', () => {
    let view: BasicView;
    let model: CubeController;
